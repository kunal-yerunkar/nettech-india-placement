...
const Partners = () => {
  const [partners, setPartners] = useState(partnerslogo);
  const [partnerCount, setPartnerCount] = useState(4500); // Default/fallback count
  ...
  useEffect(() => {
    const fetchPartners = async () => {
      try {
        ...
        console.error('Failed to fetch live partners:', error);
      }
    };
    fetchPartners();
  }, []);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-24">
          <div className="text-center mb-16 reveal active">
            ...
            <p className="text-gray-500 font-black uppercase tracking-[0.25em] text-[10px] md:text-xs">JOIN OUR NETWORK OF {partnerCount}+ HIRING PARTNERS AND ACCESS EXCEPTIONAL TALENT.</p>
          </div>
